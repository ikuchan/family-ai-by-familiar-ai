...
סקרן לגבי איך זה עובד? ראה [docs/OldDocs/technical.md](./docs/OldDocs/technical.md) עבור מחקר והחלטות עיצוב מאחורי familiar-ai — ReAct, SayCan, Reflexion, Voyager, מערכת הרצון, ועוד.
