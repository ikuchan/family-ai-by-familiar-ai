...
Nysgjerrig på hvordan det fungerer? Se [docs/OldDocs/technical.md](./docs/OldDocs/technical.md) for forskningen og designbeslutningene bak familiar-ai — ReAct, SayCan, Reflexion, Voyager, ønskesystemet, og mer.
