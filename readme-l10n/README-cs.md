...
Zajímá vás, jak to funguje? Podívejte se na [docs/OldDocs/technical.md](./docs/OldDocs/technical.md) pro výzkum a rozhodování o designu za familiar-ai — ReAct, SayCan, Reflexion, Voyager, systém touh a další.
