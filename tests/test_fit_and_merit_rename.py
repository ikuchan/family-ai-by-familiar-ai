...
def test_merit_excludes_relevance() -> None:
    ...
    a = _score_breakdown(0.5, None, None, 1.0, 0, half_life_days=3.0, floor=0.001, w_r=1.0)
    b = _score_breakdown(0.5, None, None, 1.0, 0, half_life_days=3.0, floor=0.001, w_r=3.0)
